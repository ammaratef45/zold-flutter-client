...
## installation
 - [Download](https://developer.android.com/studio) and install android studio.
    ...
    We will not use android studio but it will install all needed SDK and environment variables we may needed.
 - [Install XCode](https://developer.apple.com/xcode/)
 
   This step is optional, you will need it only if you intend to run on iPhone.
 - [Install flutter](https://flutter.dev/docs/get-started/install) by following the guide of your OS.
 
    As a brief, you can follow this [Section](#install-flutter)
